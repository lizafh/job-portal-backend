...
app.post('/jwt', async(req,res)=>{
    const user = req.body;
    const token = jwt.sign(user, process.env.ACCESS_TOKEN_SECRET, {expiresIn: '5h'});//7d
    res
     .cookie('token', token, {
        httpOnly: true,
...
// get all data, one data, many data [0, 1, many]
// http://localhost:5000/job-application?email=s.a.liza6181@gmail.com
...
//    not the best way(should use aggregate)
